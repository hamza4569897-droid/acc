                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-space-xl items-center">
                  <div className="lg:col-span-8 flex flex-col items-start text-start">
                    ...
                    <h2 className="font-headline-lg text-headline-lg text-on-surface font-bold leading-snug mb-space-md">
                      250 ماكينة حياكة تنتج جميع أنواع القمصان المحبوك من النسيج، الأصداع، البيكه، الانترلوك، jacquards وخطوط كل من المدني والهندسة.
                    </h2>
                    ...
                    <div className="flex flex-wrap gap-space-xs">
                      {['Single Jersey (السينجل جيرسي)', 'Piqué (البيكه المضلع)', 'Interlock (الانترلوك المزدوج)', 'Electronic Jacquard (الجاكارد الإلكتروني)', 'Rib & Fleece (الأصداع والميلتون)'].map(tag => (
        ...
        <div className="max-w-7xl mx-auto px-gutter-mobile lg:px-gutter-desktop">
          <div className="bg-surface-container-lowest p-space-xl lg:p-space-2xl rounded-xl shadow-sm flex flex-col lg:flex-row items-center justify-between gap-space-xl">
            ...
            <div className="flex flex-wrap items-center gap-space-md shrink-0">
              <button className="inline-flex items-center gap-space-xs px-space-xl py-space-md rounded-lg bg-primary-container text-on-primary font-label-md text-label-md hover:bg-inverse-surface transition-colors shadow-sm">
