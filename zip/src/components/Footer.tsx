    ...
    <footer className="w-full bg-surface-container-lowest shadow-[0_-1px_6px_rgba(15,23,42,0.03)] mt-auto">
      <div className="max-w-7xl mx-auto px-gutter-mobile lg:px-gutter-desktop py-space-3xl">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-space-xl">
          ...
          <div className="lg:col-span-2 flex flex-col items-start">
            <h3 className="font-title-md text-title-md font-bold text-on-surface mb-space-md">Links</h3>
            <ul className="flex flex-col gap-space-xs font-body-md text-body-md">
              <li className="flex items-center">
                <button onClick={() => setPage('home')} className="text-on-surface-variant hover:text-secondary transition-colors text-start">{t('home')}</button>
              </li>
              <li className="flex items-center">
                <button onClick={() => setPage('about')} className="text-on-surface-variant hover:text-secondary transition-colors text-start">{t('about')}</button>
              </li>
              <li className="flex items-center">
                <button onClick={() => setPage('capabilities')} className="text-on-surface-variant hover:text-secondary transition-colors text-start">{t('capabilities')}</button>
              </li>
              <li className="flex items-center">
                <button onClick={() => setPage('contact')} className="text-on-surface-variant hover:text-secondary transition-colors text-start">{t('contact')}</button>
              </li>
            </ul>
          </div>
          
          <div className="lg:col-span-3 flex flex-col items-start">
            <h3 className="font-title-md text-title-md font-bold text-on-surface mb-space-md">Branches</h3>
            <div className="flex flex-col gap-space-sm font-body-md text-body-md text-on-surface-variant">
              <div className="flex items-start gap-space-xs">
                <MapPin className="w-5 h-5 text-secondary shrink-0" />
                <p className="leading-snug">Alexandria, Egypt</p>
              </div>
              <div className="flex items-start gap-space-xs">
                <Building2 className="w-5 h-5 text-secondary shrink-0" />
                <p className="leading-snug">Free Zone, Alexandria</p>
              </div>
              <div className="flex items-start gap-space-xs">
          ...
          <div className="lg:col-span-3 flex flex-col items-start">
            <h3 className="font-title-md text-title-md font-bold text-on-surface mb-space-md">Quality</h3>
      ...
      <div className="w-full bg-surface-container-low py-space-md">
        <div className="max-w-7xl mx-auto px-gutter-mobile lg:px-gutter-desktop flex flex-col sm:flex-row items-center justify-between gap-space-xs font-caption-code text-caption-code text-on-surface-variant">
          <span className="tracking-wide" dir="ltr">americanfreezone.com | © Copyright 2024, {t('rights', 'footer')}</span>
