...
import { 
  ...
  AtSign, Mail, Building2, Globe, ShieldCheck, Factory, CheckCircle2
} from 'lucide-react';
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-space-lg">
          ...
          <div className="bg-surface-container-lowest rounded-xl shadow-md p-space-lg flex flex-col justify-between transition-transform duration-200 hover:-translate-y-1">
            ...
            <div className="w-full h-44 rounded-lg overflow-hidden relative shadow-sm">
              <iframe 
                title="موقع مجمع مرغم الصناعي - American Group"
                width="100%" 
                height="100%" 
                style={{ border: 0 }} 
                loading="lazy" 
          ...
          <div className="bg-surface-container-lowest rounded-xl shadow-md p-space-lg flex flex-col justify-between transition-transform duration-200 hover:-translate-y-1">
            ...
            <div className="w-full h-44 rounded-lg overflow-hidden relative shadow-sm">
              <iframe 
                title="موقع المنطقة الحرة العامة بالعامرية - Qiz Group"
                width="100%" 
                height="100%" 
                style={{ border: 0 }} 
                loading="lazy" 
          ...
          <div className="bg-surface-container-lowest rounded-xl shadow-md p-space-lg flex flex-col justify-between transition-transform duration-200 hover:-translate-y-1">
            ...
            <div className="w-full h-44 rounded-lg overflow-hidden relative shadow-sm">
              <iframe 
                title="موقع مصانع فرست جروب - First Group"
                width="100%" 
                height="100%" 
                style={{ border: 0 }} 
                loading="lazy" 
      ...
      <section className="max-w-7xl mx-auto w-full px-gutter-mobile lg:px-gutter-desktop py-space-3xl">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-space-xl items-start">
          ...
          <div className="lg:col-span-7 bg-surface-container-lowest rounded-xl p-space-xl shadow-md flex flex-col gap-space-md">
            ...
            {rfqSubmitted ? (
              <div className="p-space-xl rounded-xl bg-secondary-container/30 border border-secondary/20 flex flex-col items-center text-center gap-space-md my-space-md">
                <div className="w-14 h-14 rounded-full bg-secondary text-on-secondary flex items-center justify-center">
                  <CheckCircle2 className="w-8 h-8" />
                </div>
                <h3 className="font-title-lg text-title-lg font-bold text-on-surface">تم استلام طلبكم بنجاح</h3>
                <p className="font-body-md text-body-md text-on-surface-variant max-w-md">
                  شكراً لتواصلكم مع American Group. سيقوم فريق المشتريات والتسعير الدولي بدراسة المواصفات والرد عليكم خلال 48 ساعة كحد أقصى.
                </p>
                <button
                  onClick={() => setRfqSubmitted(false)}
                  className="px-space-lg py-space-xs rounded bg-secondary text-on-secondary font-label-md text-label-md hover:bg-secondary-fixed hover:text-on-secondary-fixed transition-colors cursor-pointer"
                >
                  إرسال طلب آخر
                </button>
              </div>
            ) : (
              <form className="flex flex-col gap-space-md mt-space-xs" onSubmit={handleRfqSubmit}>
                ...
                <button className="w-full h-12 rounded bg-primary-container text-on-primary hover:bg-inverse-surface font-label-md text-label-md flex items-center justify-center gap-space-xs shadow-md transition-colors cursor-pointer" type="submit">
          ...
          <div className="lg:col-span-5 flex flex-col gap-space-xl">
            <div className="bg-surface-container-lowest rounded-xl p-space-xl shadow-md flex flex-col gap-space-md">
              ...
              {supportSubmitted ? (
                <div className="p-space-lg rounded-xl bg-secondary-container/30 border border-secondary/20 flex flex-col items-center text-center gap-space-sm my-space-sm">
                  <CheckCircle2 className="w-8 h-8 text-secondary" />
                  <h4 className="font-title-md text-title-md font-bold text-on-surface">تم استلام استفساركم</h4>
                  <p className="font-body-md text-body-md text-on-surface-variant">
                    تم تحويل البلاغ لقسم العمليات اللوجستية، وسنقوم بالرد عليكم سريعاً.
                  </p>
                  <button
                    onClick={() => setSupportSubmitted(false)}
                    className="px-space-md py-space-2xs rounded bg-secondary text-on-secondary font-label-sm text-label-sm hover:bg-secondary-fixed hover:text-on-secondary-fixed transition-colors cursor-pointer"
                  >
                    استفسار جديد
                  </button>
                </div>
              ) : (
                <form className="flex flex-col gap-space-md" onSubmit={handleSupportSubmit}>
                  <div className="flex flex-col gap-space-2xs">
                  ...
                  <button className="w-full h-11 rounded bg-secondary text-on-secondary hover:bg-secondary-fixed hover:text-on-secondary-fixed font-label-md text-label-md flex items-center justify-center gap-space-xs shadow-sm transition-colors cursor-pointer" type="submit">
